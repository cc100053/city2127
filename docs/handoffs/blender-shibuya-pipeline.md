...
- Review this documentation-only diff and local links, push the branch, verify CI, integrate and publish main. On another collaborator's machine, run the documented local setup and record actual results before claiming that host works.
