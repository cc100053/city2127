...
| `src/modelAssets.ts` | Load an explicitly selected Blender GLB with Three.js GLTFLoader and place it in scene coordinates; no production models are configured yet |
