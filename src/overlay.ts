...
export function overlay(choose: (name: StateName) => void) {
  ...
  const names = { neutral:'DUSK TOKYO', pulse:'PULSE TOKYO', still:'STILL TOKYO' };
  const times = { neutral:'18:40', pulse:'21:30 ∞', still:'06:12 ∞' };
  let previous = '';
